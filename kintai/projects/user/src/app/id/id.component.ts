...
export class IdComponent implements OnInit {
  ...
  constructor(private procResultService: ProcResultService, private aditRepository: AditRepository) { }
  ...
  onCardId(id) {
    ...
    this.procResultService.proc(true, () => this.aditRepository.createByFelica(id));
  }
